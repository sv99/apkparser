...
public interface DexEntry {
    @Nullable
    static DexEntry fromNode(@Nullable Object value) {
        ...
        if (!(userObject instanceof DexEntry)) {
            return null;
        }

        return (DexEntry) userObject;
    }
    ...
    static void sort(@NonNull DefaultMutableTreeNode node) {
        ...
        children.sort((o1, o2) -> {
            DexEntry entry1 = fromNode(o1);
            DexEntry entry2 = fromNode(o2);
